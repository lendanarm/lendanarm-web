...
const socialIcons = [
  {
    ...
    href: "https://github.com/lendanarm"
  },
  {
    icon: (
      <svg
  ...
  return (
    <footer>
      <div className={classes.footerInner}>
        <Grid container spacing={isWidthUp("md", width) ? 10 : 5} style={{width: "100%", margin: 0, flexDirection: "column" }} >
          <div style={{ display: "flex", justifyContent: "center" }}>
            {footerMenu.map((menuItem, index) => (
              <Breadcrumbs aria-label="breadcrumb" style={{ textAlign: "center" }} className={classes.footerMenuItem}>
          ...
          <div className={classes.copySection}>
            <div className={classes.copyRights}>© {new Date().getFullYear()} Lend an Arm</div>
